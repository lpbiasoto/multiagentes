...
public class InterfaceHecate {
    ...
    public static String POSTConnection(String command, String idAgente, String parametros) throws Exception {
        final String GET_COMMAND = command;
        //System.out.println(GET_COMMAND);

        final String GET_PARAMS = "/?id="+idAgente;
        //System.out.println(GET_PARAMS);
        ...
        String jsonInputString = parametros;
